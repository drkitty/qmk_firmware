...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [NON] = {
    ...
    {
      MO(SYM), KC_Z   , KC_X   , KC_M   , KC_C   , KC_V   ,
      KC_K   , KC_L   , KC_COMM, KC_DOT , KC_SCLN, MO(SYM),
    },
    {
  ...
  [NAV] = {
    ...
    {
      _______, MO(NAV), _______, _______, _______, _______,
      _______, _______, _______, _______, MO(NAV), RESET  ,
    },
  },
};
